...
#
# Trabalho de Conclusão das Disciplinas:
# 1. Linguagem de Programação R - Prof. Sérgio Monteiro
# 2. Estatística Aplicada - Prof. Manuel Martins
#
# Autores do Trabalho:
#  1. Aline
#  2. Allan Santana
...
# 09/05/2022  Carlos Ferreira   Versão Inicial
#===============================================================================
...
diretorio <- "C:\\05. UniCarioca-Pós-Graduação em Ciência de Dados\\01. Linguagem de Programação Aplicada R\\Trabalho\\"
